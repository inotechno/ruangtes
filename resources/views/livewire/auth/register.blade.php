                    ...
                    <div class="mt-3">
                        ...
                        <div class="mt-3 d-grid text-center">
                            <a class="btn btn-outline-success waves-effect waves-light d-flex align-items-center justify-content-center gap-2"
                                href="#" wire:click="showPublicUserSignup">
                                <span>{{ __('app.buttons.signup_for_public_user') }}</span>
                                <i class="mdi mdi-account-plus "></i>
                            </a>
                        </div>

                        <div class="mt-2 d-grid text-center"> <button
                                class="btn btn-outline-danger waves-effect waves-light d-flex align-items-center justify-content-center gap-2"
                                href="#" wire:click="showCompanySignup">
